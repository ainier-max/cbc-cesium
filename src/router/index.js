    ...
    children: [
      {
        ...
        path: "mapAccess",
        component: () =>
          import("@/components/FFCesiumMain/MapAccess/index.vue"),
      },
      {
        name: "MapOperate",
        path: "MapOperate",
        component: () =>
          import("@/components/FFCesiumMain/MapOperate/index.vue"),
      },
      {
        name: "MapGather",
        path: "MapGather",
        component: () =>
          import("@/components/FFCesiumMain/MapGather/index.vue"),
      },
      {
        name: "MapEffect",
        path: "MapEffect",
        component: () =>
          import("@/components/FFCesiumMain/MapEffect/index.vue"),
      },
      {
        name: "SpatialAnalysis",
        path: "SpatialAnalysis",
        component: () =>
          import("@/components/FFCesiumMain/SpatialAnalysis/index.vue"),
      },
      {
        name: "AdvancedExamples",
        path: "AdvancedExamples",
        component: () =>
          import("@/components/FFCesiumMain/AdvancedExamples/index.vue"),
      },
    ],
  },
];
